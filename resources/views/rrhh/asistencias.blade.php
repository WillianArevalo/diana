...
@section('content')
    <div class="flex flex-col items-center justify-center overflow-x-hidden">
        ...
        <div class="mb-4 mt-10 flex w-full flex-col items-center px-4 font-roboto text-white">

            <div class="mb-4 flex w-full items-center justify-end">
                <a href="{{ route('rrhh.asistencias.excel') }}"
                    class="flex items-center gap-2 rounded-md bg-secondary px-4 py-2 font-poppins uppercase text-primary hover:bg-yellow-300">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="icon icon-tabler icons-tabler-outline icon-tabler-download h-4 w-4 text-current">
                                                ...
                                                @if (
                                                    ...
                                                    <span
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" class="h-3 w-3 text-current" viewBox="0 0 24 24"
